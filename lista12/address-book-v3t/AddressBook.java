...
public class AddressBook
{
     ...
     * @throws DuplicateKeyExcepion
     */
    public void addDetails(ContactDetails details) throws DuplicateKeyExcepion
    {
        if(details == null) {
            throw new IllegalArgumentException("Null details passed to addDetails.");
        }
      //Fazemos um for para obeter o ContactDeails de todo mundo
      for(ContactDetails it:book.values()){
        //verificamos se
        if(it.equals(details)){

            throw new DuplicateKeyExcepion();}
      }
