...
public class LabClass
{
    ...
    {
        instructor = new Instructor("Roger",40);
        room = "unknown";
        timeAndDay = "unknown";
        students = new ArrayList<Pessoa>();
     ...
     */
    public void setInstructor(String instructorName,int age)
    {
        instructor = new Instructor(instructorName,age);
    }
